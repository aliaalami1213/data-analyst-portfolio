...
- `data/README.md` — dataset source link (the raw CSV is included directly in `data/` for projects 1, 2, and 4 so the notebook runs out of the box; project 3 fetches its data at runtime — see its `data/README.md`)
